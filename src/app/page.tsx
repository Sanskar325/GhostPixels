        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-primary font-headline">GhostPixels</h1>
            </div>
            <p className="text-muted-foreground hidden sm:block">Hide your secrets in plain sight.</p>
          </div>
        </div>
      </header>
